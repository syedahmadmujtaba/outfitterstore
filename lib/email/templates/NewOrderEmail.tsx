...
export function NewOrderEmail({ orderNumber, email, items, total, adminUrl }: NewOrderEmailProps) {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Order <strong>#{orderNumber}</strong> has been placed by <strong>{email}</strong>.
          </Text>
          <Hr style={hr} />
          {items.map((item, i) => (
